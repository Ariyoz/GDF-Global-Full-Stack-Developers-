...
@media (min-width: 640px) {
  .devs-grid { grid-template-columns: repeat(2, 1fr); gap: 1rem; }
}
...
@media (max-width: 479px) {
  .dev-bio { font-size: 0.72rem; -webkit-line-clamp: 1; }
}
...
@media (max-width: 479px) {
  .dev-footer-actions { flex-direction: column; gap: 0.3rem; }
